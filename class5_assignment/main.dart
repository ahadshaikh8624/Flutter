...
void main() {
  print("Welcome To Noor's Unit Converter Console App");
  convertUnits();
}
...
void convertUnits() {
  ...
  while (true) {
    ...
    if (userInputToSelectUnits.isNotEmpty) {
      ...
      if (mapKey == "Length") {
        //--- Length conversion Functions called ---//
        ...
        //--- Temperature conversion Functions called ---//
        if (indexNumberOfSublist == 1) {
        ...
        //--- Area conversion Functions called ---//
        if (indexNumberOfSublist == 1) {
        ...
        //--- Weight conversion Functions called ---//
        if (indexNumberOfSublist == 1) {
        ...
        //--- Time conversion Functions called ---//
        if (indexNumberOfSublist == 1) {
...
// ------------------------- Mini Functions Starts ----------------------- //

// For Lengths Conversions
